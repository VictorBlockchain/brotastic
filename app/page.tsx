    ...
    <div className={`min-h-screen bg-gradient-to-br from-purple-600 to-blue-500 text-white ${roboto.className}`}>
      ...
      <main className="container mx-auto px-6 py-12">
        <section id="home" className="mb-20">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="md:w-1/2">
              <motion.h2 
                className={`text-6xl font-extrabold mb-6 ${orbitron.className}`}
                initial={{ scale: 0.5, opacity: 0 }}
                animate={{ scale: 1, opacity: 1 }}
                transition={{ type: "spring", stiffness: 100 }}
              >
                The Ultimate Bro Coin
              </motion.h2>
              <motion.p 
            ...
            <div className="md:w-1/2 mt-6 md:mt-0">
              <Image src="/elon.png" width={400} height={400} alt="Brotastic Meme" className="w-full h-auto rounded-lg shadow-lg" />
            </div>
          </div>
        </section>
        ...
        <section id="buy" className="mb-20">
          <h2 className={`text-4xl font-bold mb-6 ${orbitron.className}`}>Buy Brotastic</h2>
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="md:w-1/2">
              ...
              <ol className="list-decimal list-inside space-y-2">
                <li>Set up a Solana wallet</li>
                <li>Buy SOL from an exchange</li>
                <li>Transfer SOL to your wallet</li>
                <li>Use a Solana DEX to swap for Brotastic</li>
                <li>HODL and enjoy the ride, bro!</li>
              </ol>
            </div>
            <div className="md:w-1/2 mt-6 md:mt-0">
              <Image src="/placeholder.svg" width={400} height={300} alt="Bros Buying Crypto" className="w-full h-auto rounded-lg shadow-lg" />
            </div>
          </div>
        </section>
